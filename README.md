# Rafli Ahmad Fachrezi - Portfolio
...
- **Experience:** A timeline of my professional experience in QA Automation and Fullstack Development.
- **Selected Works:** Detailed case studies of my automation frameworks, tools, and web applications.
...
- **Language:** TypeScript
- **Styling:** Tailwind CSS (with custom cinematic theming)
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/maseylan/PortoRafli-.git
   cd PortoRafli-
   ```
...
- **Experience:** Update the `EXPERIENCE_DATA` array.
- **Profile Picture & Backgrounds:** Update the `BIOGRAPHY_PORTRAIT` and `LIGHT_BEAM_HERO_BG` constants.
- **Tags & Brands:** Update `STUDIO_LOGO` and `PHILOSOPHY_TAGS`.
